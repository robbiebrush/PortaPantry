...
import com.example.portapantry.forms.AddFoodTab;
import com.example.portapantry.forms.FoodTab;
import com.example.portapantry.forms.StatsFoodTab;
...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        labelWelcome.setFont(Font.font(28));
        ...
        loginContent.getChildren().addAll(welcome, images, instructs, dbInput, userInput, passInput, button);
